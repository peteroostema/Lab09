 ...
 * @version November, 2016 - added in code from VanderLinden for receiving database records
 */
@Path("/monopoly")
public class MonopolyResource {
    ...
    public String getPlayers() {
        try {
            ...
            List<Player> softCodedPlayers = retrievePlayers();
...
//            hardCodedPlayers.add(new Player(2, "jdoe2", "Jane Doe"));
            return new Gson().toJson(softCodedPlayers);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    private List retrievePlayers() throws Exception {
        ...
        try {
            ...
            //System.out.println(statement.executeQuery("SELECT * FROM Player"));
